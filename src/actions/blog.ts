...
import { fetcher, endpoints, poster } from 'src/lib/axios';
...
export function useGetPosts() {
  ...
  const { data, isLoading, error, isValidating } = useSWR<PostsData>(url, poster, swrOptions);
  const memoizedValue = useMemo(
    () => ({
      ...
      postsEmpty: !isLoading && !data?.projects.length,
    }),
